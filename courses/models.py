    ...
    def get_events(self, course_set=False):
        ...
        for course in course_set:
            for event in course.schedule.all():
                occurrences.append([(single_occurence, event) for single_occurence in
                                    event.recurrences.occurrences(dtstart=start, dtend=end)])
...
class Course(models.Model):
    ...
    teaching_assistants = models.ManyToManyField(User, related_name=_('teaching_assistants'))
...
class AssignmentSubmission(models.Model):
    users = models.ForeignKey(User, related_name='submitters')
...
class Attendance(models.Model):
    course = models.ForeignKey(Course)
    student = models.ForeignKey(User, related_name='attendance')
